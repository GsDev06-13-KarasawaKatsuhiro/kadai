...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO gs_bm_table(id, name, url, comment, indate, pprice, currentprice, issuedate, kprice )
VALUES(NULL, :name, :url, :comment, sysdate(), :pprice, :currentprice, :issuedate, :kprice)");
